...
User.create(first_name: "Alphonse", last_name: "popotte", username: "popotte", email: "popotte@msn.com", password: "azerty", city: "Marseilles")
User.create(first_name: "Noemie", last_name: "viral", username: "nono", email: "nono.v@msn.com", password: "azerty", city: "Marseilles")
User.create(first_name: "Capucine", last_name: "fabien", username: "capu", email: "capupu@amsn.com", password: "azerty", city: "Marseilles")
User.create(first_name: "Aurelie", last_name: "Moreaux", username: "aurel", email: "aurel@masn.com", password: "azerty", city: "Marseilles")
User.create(first_name: "Jonathan", last_name: "bartiz", username: "jojo", email: "jojojo@msan.com", password: "azerty", city: "Marseilles")
User.create(first_name: "Bastien", last_name: "Lorem", username: "bast", email: "bast@msan.com", password: "azerty", city: "Marseilles")
User.create(first_name: "Nathalie", last_name: "Natier", username: "nat", email: "natata@msna.com", password: "azerty", city: "Marseilles")
User.create(first_name: "Marine", last_name: "Dupuis", username: "mama", email: "mamarine@msnaa.com", password: "azerty", city: "Marseilles")
